...
public class ValidatorUtil {
    ...
    public static boolean isLetter(CharSequence value) {
        return StrUtil.isAllCharMatch(value, t -> Character.isLetter(t));
    }
    ...
    public static boolean isUpperCase(CharSequence value) {
        return StrUtil.isAllCharMatch(value, t -> Character.isUpperCase(t));
    }
    ...
    public static boolean isLowerCase(CharSequence value) {
        return StrUtil.isAllCharMatch(value, t -> Character.isLowerCase(t));
    }
     ...
     * @param columnNames
     */
    public static void notEmpty(Map<String, Object> map, String columnNames) {
        if (MapUtil.isEmpty(map)) {
            throw new ValidateException("未获取到参数");
        }

        List<String> columnList = Arrays.asList(columnNames.split(","));
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            if (columnList.contains(entry.getKey())) {
                Validator.validateNotEmpty(entry.getValue(), "必传参数缺失：" + entry.getKey());
            }
        }
    }
     ...
     * @param columnNames
     */
    public static void notEmpty(Object obj, String columnNames) {
        Validator.validateNotEmpty(obj, "未获取到参数");
        notEmpty(BeanUtil.beanToMap(obj), columnNames);
    }
}
